...
\begin{description}
 ...
 Observando este resultado, verificamos que se encaixa com o melhor (geral) do QuickSort. Então, aplicando o segundo caso do teorema master, obtemos a solução de $f(n) = \Theta(n lg n)$.
